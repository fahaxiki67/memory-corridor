...
from .contract import GuardError, ProjectPaths, _atomic_write, load_state, notebook_tail
...
def write_packet(paths: ProjectPaths, *, out: str | Path | None = None, max_evidence: int = 10, notebook_lines: int = 20) -> Path:
    packet = build_packet(paths, max_evidence=max_evidence, notebook_lines=notebook_lines)
